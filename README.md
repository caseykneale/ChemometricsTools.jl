...
## ToDo:
  - Docs (Update): Peakfinding, NB, tree methods, MaxVoteOneHot, boxcar, boxcox, norms, snv, RandomForest...
  - Docs (Make): Method shoot-out for regression/classification/etc...
  - BTEM / MultiObjective Simulated Annealing Optimizer (Or maybe a PSO) (from scratch) ...
